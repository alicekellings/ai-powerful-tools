interface ProductSpecificOfferSectionProps {
  payhipLink: string;
  productName: string;
}

const ProductSpecificOfferSection = ({
  payhipLink,
  productName,
}: ProductSpecificOfferSectionProps) => (
    ...
    <div className="mx-auto max-w-screen-md px-4">
      <div className="relative rounded-3xl border-4 border-action bg-white p-8 text-center shadow-2xl md:p-12">
        ...
        <h2 className="mb-2 text-3xl font-black md:text-4xl">
          Get {productName} Lifetime Access
        </h2>
        ...
        <ul className="mx-auto mb-10 max-w-xs space-y-3 text-left text-lg">
          ...
          <li>
            ✅ <strong>Bonus:</strong> Premium Support
          </li>
          <li>
            ✅ <strong>Bonus:</strong> Future Updates
          </li>
        </ul>
        ...
        <div className="mt-10 flex flex-col items-center gap-6 rounded-xl border border-green-200 bg-green-50 p-6 md:flex-row">
          ...
          <div className="text-left">
            ...
            <span className="text-sm leading-relaxed text-green-700">
              Try it for 30 days. If you don&apos;t see benefits from using{' '}
              {productName}, we&apos;ll refund every penny. No questions asked.
            </span>
          </div>
        </div>
...
export { ProductSpecificOfferSection };
